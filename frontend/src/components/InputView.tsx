...
const EMPTY = { question: '', choice_a: '', choice_b: '', choice_c: '', choice_d: '', correct: 'a' as const }
  ...
  return (
    <div className={styles.container}>
      ...
      <form className={styles.form} onSubmit={handleSubmit}>
        ...
        <label className={styles.label}>
          正解
          <select className={styles.select} value={form.correct} onChange={set('correct')}>
            {(['a', 'b', 'c', 'd'] as const).map((k, i) => (
              <option key={k} value={k}>{['ア', 'イ', 'ウ', 'エ'][i]}</option>
            ))}
          </select>
        </label>
